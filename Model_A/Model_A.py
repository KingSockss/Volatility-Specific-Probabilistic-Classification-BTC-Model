...
USER_AGENT = "model-a-garch-studentt-builder/1.0"

OUTPUT_FOLDER_NAME = "Model_A_Output_Raw_Data"
EPS = 1e-12
MIN_VARIANCE = 1e-12
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Build Model A raw hourly forecast files by combining settlement-defined Kalshi "
